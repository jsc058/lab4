...
var otherPosts = require('./routes/otherPosts');
var writePost = require('./routes/writePost');
...
app.get('/individualPosts/:title', indPosts.viewIndPosts);
app.get('/otherPosts/:title', otherPosts.viewOtherPosts);
app.get('/writePost', writePost.viewWritePost);
